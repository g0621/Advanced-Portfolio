...
class Portfolios extends React.Component {
                ...
                <Col key={index} md="4">
                    <PortfolioCard portfolio={portfolio}>
                        ...
                        <React.Fragment>
                            ...
                            <Button onClick={(e) => this.displayDeleteWarning(portfolio._id, e)}
    ...
    render() {
        ...
        return (
            <BaseLayout title="Gyan Vardhan | My Projects" {...this.props.auth}>
                <BasePage className="portfolio-page" title="Projects">
                    ...
                    <Row>
                        {portfolios && this.renderPortfolios(portfolios)}
                    </Row>
                </BasePage>
            </BaseLayout>
        )
