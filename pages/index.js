...
class Index extends React.Component {
    ...
    render() {
        ...
        return (
            <BaseLayout className={`${isFlipping ? 'cover-1' : 'cover-0'}`} {...this.props.auth}
                        headerType="index"
                        title="Gyan Vardhan | Portfolio">
                                ...
                                <div className="hero-section">
                                    <div className={`flipper ${isFlipping ? 'isFlipping' : ''}`}>
                                        <div className="front">
                                            ...
                                            <img alt="Guy programming welcome picture" className="image"
                            ...
                            <Col md="6" className="hero-welcome-wrapper">
                                <div className="hero-welcome-text">
                                    <h1>
                                        ...
                                        Welcome to the portfolio website of Gyan Vardhan.
