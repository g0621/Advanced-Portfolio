...
export const getPortfolios = async () => {
  return await axiosInstance.get('/portfolios').then(response => response.data).catch((err) =>{
...
export const getPortfolioById = async (id) => {
  return await axiosInstance.get(`/portfolios/${id}`).then(response => response.data).catch((err) =>{
    console.log(err.message);
  });
}
...
export const getProjects = async () => {
  return await axiosInstance.get('/project/all').then(response => response.data).catch((err) =>{
    console.log(err.message);
  });
}

export const loadProjects = async () => {
  return await axiosInstance.get('/project/load').then(response => response.data).catch((err) =>{
    console.log(err.message);
  });
}
